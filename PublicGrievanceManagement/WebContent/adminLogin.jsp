    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item" style="text-align:right;">
          <a class="nav-link" href="login.jsp"><h3>User Login</h3></a>
        </li>
      </ul>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm-5">
          ...
          <form class="form-horizontal" modelAttribute="Alogin" action="./adminloginSuccess" method="post" >
            <fieldset>
              <legend>
                <h1 style="font-family:sans sherif">Login Form</h1>
              </legend>
              <div class="form-group">
                <label style="font-family: Ariel black" ; class="control-label col-sm-2" ><h3>
                    Name</h3></label>
                <div class="col-sm-7">
                  <input type="text" class="form-control" id="email" placeholder="Enter Name" name="Admin_Name">
                </div>
              </div>
